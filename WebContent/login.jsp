												...
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150><INPUT id="un" required
														...
														<TR>
															...
															<TD style="HEIGHT: 28px"><INPUT id=txtPwd
																style="WIDTH: 130px" type=password required
																name="user.user_password"></TD>
														...
														<TR>
															<TD><span style="color: red;"><c:if test="${msg!=null}">${msg }</c:if></span>
														</TD>
