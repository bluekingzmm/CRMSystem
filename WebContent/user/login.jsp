...
<BODY>
	<FORM id=form1 name=form1 method=post action="<c:url value="/loginUser"/>">
												...
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150><INPUT id="user.user_name" required
														...
														<TR>
															...
															<TD style="HEIGHT: 28px"><INPUT id=txtPwd required
																style="WIDTH: 130px" type=password name="user.user_password"></TD>
