								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
														<TD class=menuSmall><A class=style2 href="<c:url value="/createCustomer"/>" 
														target=main>－ 新增客户</A></TD>
											<%-- 		<TD class=menuSmall><A class=style2 href="<c:url value="/CustomerServlet?method=add"/>" 
														target=main>－ 新增客户</A></TD> --%>
												</TR>
												<TR> 
												<TD class=menuSmall><A class=style2 href="<c:url value="/listCustomer"/>"
														target=main>－ 客户列表</A></TD>
													<%-- <TD class=menuSmall><A class=style2 href="<c:url value="/CustomerServlet?method=list"/>"
														target=main>－ 客户列表</A></TD> --%>
												</TR>
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
												<TD class=menuSmall><A class=style2 href="<c:url value="/createLinkMan"/>"
														target=main>－ 新增联系人</A></TD>
													<%-- <TD class=menuSmall><A class=style2 href="<c:url value="/LinkManServlet?method=add"/>"
														target=main>－ 新增联系人</A></TD> --%>
												</TR>
												<TR>
												<TD class=menuSmall><A class=style2 href="<c:url value="/listLinkMan"/>"
														target=main>－联系人列表</A></TD>
													<%-- <TD class=menuSmall><A class=style2 href="<c:url value="/LinkManServlet?method=list"/>"
														target=main>－联系人列表</A></TD> --%>
												</TR>
