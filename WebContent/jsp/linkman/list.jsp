...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/listLinkMan"
		method=post>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="keyString"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/updateLinkMan?linkMan.lkm_id=${linkman.lkm_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/deleteLinkMan?linkMan.lkm_id=${linkman.lkm_id}">删除</a>
													</TD>
													<%-- <TD>
